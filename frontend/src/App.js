...
import PChilds from "./components/pages/Dashboard/ParentFunc/PChilds";
    ...
    <Router>
      <div className="app">
        <Switch>
          ...
          <Route exact path="/pviewchilds" component={PChilds} />
