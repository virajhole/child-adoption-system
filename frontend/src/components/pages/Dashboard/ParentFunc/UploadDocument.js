...
const UploadDocument = () => {
  ...
  const [nationalityCertificate, setNationalityCertificate] =
    useState(undefined);
  const [nonCriminal_certificate, setNonCriminal_certificate] =
    useState(undefined);
  ...
  const addDocumentToDB = () => {
    if (!addressProof) {
      ...
      axios
        .post(`http://localhost:8080/document/adddocument/${user1.id}`, data)
        .then((response) => {
        ...
        <div className="col-10">
          <div className="mb-3">
            ...
            <input
              ...
              // onChange={onFileSelect}
              onChange={(e) => {
                setNationalityCertificate(e.target.files[0]);
              }}
              type="file"
              className="form-control"
            />
        ...
        <div className="col-10">
          <div className="mb-3">
            ...
            <input
              ...
              // onChange={onFileSelect}
              onChange={(e) => {
                setNonCriminal_certificate(e.target.files[0]);
              }}
              type="file"
              className="form-control"
            />
