      ...
      <ListGroup>
        ...
        {/* <ListGroupItem>
          <NavLink className="nav-link" exact to="/adoptionform">
            <Button outline color="secondary">
              ...
              <i className="fa fa-2x fa-registered"></i>
            </Button>
          </NavLink>
        </ListGroupItem> */}
        ...
        <ListGroupItem>
          <NavLink className="nav-link" exact to="/upload-documents">
            <Button outline color="success">
              Upload Documents<i className="fa fa-2x fa-upload"></i>
            </Button>
          </NavLink>
        </ListGroupItem>
        ...
        <ListGroupItem>
          <NavLink className="nav-link" exact to="/request-status">
            <Button outline color="secondary">
              ...
              <i className="fa fa-2x fa-reply-all"></i>
            </Button>
          </NavLink>
        </ListGroupItem>
        ...
        <ListGroupItem>
          <NavLink className="nav-link" exact to="/peditprofile">
            <Button outline color="danger">
             Update Profile<i className="fa fa-cog fa-spin fa-3x fa-fw"></i>
            </Button>
          </NavLink>
        </ListGroupItem>
      </ListGroup>
